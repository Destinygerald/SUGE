    ...
    <div className="contact-2-info" id="suge-contact-2-info-cnt">
      ...
      <div className="contact-2-info-cnt">
        ...
        <div className="contact-2-info-item">
          ...
          <div
            className="contact-2-info-details"
            id="suge-contact-2-info-phone"
          >
            <span>Phone</span>
...
function ContactForm() {
  ...
  async function submitHandler(e) {
    ...
    try {
      ...
      dispatch(
        addMessage({ label: "Message sent successfully", type: "success" })
      );
      setFormDetails({
        name: "",
        email: "",
      ...
      dispatch(
        addMessage({ label: "Error Contacting us, try again", type: "error" })
      );
    }
  }
...
function Page() {
  return (
    <div className="contact-2">
      <SEO
        title={`Suge - Contact Us | Sustainable Organic Waste Collection & Management UK`}
        link="https://www.suge.uk.co/contact/2"
      />
