...
function SidebarItem({ text, icon, nav, classCheck }) {
  ...
  return (
    ...
    >
      ...
      {classCheck ? <div className="active-side" /> : <></>}
    </div>
  );
}
      ...
      <div className="admin-sidebar-cnt">
        <SidebarItem
          ...
          classCheck={
            ...
            !pathname.split("/").includes("popups")
          }
        />
        <SidebarItem
          text="Blogs"
          icon={<FaRegNewspaper />}
          nav="blog"
          classCheck={pathname.split("/").includes("blog")}
        />
        <SidebarItem
          text="Popups"
          icon={<FaPager />}
          nav="popups"
          classCheck={pathname.split("/").includes("popups")}
        />
      </div>
    </div>
  );
...
function MobileSlider({ setMenu }) {
  ...
  return (
    <div className="admin-slider">
      <span className="admin-slider-exit" onClick={() => setMenu(false)}>
        {" "}
        <BsX />{" "}
      </span>
  ...
  return (
    <div className="admin-dashboard">
      ...
      <div className="admin-dashboard-main">
        ...
        {menu ? <MobileSlider setMenu={setMenu} /> : <></>}
            ...
            <Route
              ...
              element={
                <div className="unavailable">
                  Orders are unavailable for now.
                </div>
              }
            />
            <Route
